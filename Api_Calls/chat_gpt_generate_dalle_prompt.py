    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"Based on the following text generate a dalle prompt for a youtube thumbnail: {text_chunk} Also make sure not to violate open ai's content safety policy. The art style should look professionally drawn. In the style of an epic fantasy image. No text in the image."}
            ]
        )
